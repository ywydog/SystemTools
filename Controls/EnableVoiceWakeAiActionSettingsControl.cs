...
public class EnableVoiceWakeAiActionSettingsControl : ActionSettingsControlBase<EnableVoiceWakeAiActionSettings>
{
    private ToggleSwitch _enableToggle;
    private CheckBox _notifyCheckBox;

    public EnableVoiceWakeAiActionSettingsControl()
    {
