...
public class SettingsPageLazy : ContentControl
{
    ...
    private static void SetupImplicitTransitionAnimation(Control control)
    {
    ...
    private static void SetCompositionOpacity(Control? control, float opacity, double delayMs = 0)
    {
        if (control == null)
        {
            return;
